...
if(navToggle){
    navToggle.addEventListener('click',function(){
        nevMenu.classList.add('show-menu')
    })
}
...
const sendEmail = function(e){
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactMessage.value === ''){
        ...
        contactHint.classList.remove('color-blue')
        contactHint.classList.add('color-red')
        // Show message	
        contactHint.textContent = 'Write all the input fields ✍️'
    }else{
        // serviceID - templateID - #form - publicKey
        emailjs.sendForm('melodych14992027','template_6568e4f','#contact-form','VlVHWVJULvfJMPrvo')
                  .then(()=>{
                    // Show message and add color
                    contactHint.classList.add('color-blue'),
                    contactHint.textContent = 'Message sent ✅'
